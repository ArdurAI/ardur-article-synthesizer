 ...
 */
import type { AggregationArtifact, Top10Artifact, CycleMeta } from './contracts.ts';
...
export type { ClaimInput, LegacyClaimProvenance, ProvenanceMap, FactProvenanceResult, SupportStrength, } from './provenance.ts';
 ...
 */
export declare function runSynthesis(options: SynthesisOptions): Promise<ArticleArtifactExtended>;
